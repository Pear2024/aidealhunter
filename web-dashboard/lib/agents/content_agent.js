...
3. SOCIAL: Draft a viral Facebook caption for the same deal.
   ...
   - Use 'publish_facebook_post'. Pass the tracking link: 'https://aidealhunter.vercel.app/r/' + source_deal_id. CRITICAL: Pass the "image_url" returned from the blog publishing tool into the Facebook tool so it uploads as a gorgeous Photo Post!
