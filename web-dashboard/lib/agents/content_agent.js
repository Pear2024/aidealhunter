...
3. SOCIAL: Draft a viral Facebook caption for the same deal.
   ...
   - Use 'publish_facebook_post'. Pass the exact 'affiliate_url' that was provided by the 'fetch_approved_deal' tool into the link_url field instead of using the custom domain link. CRITICAL: Pass the "image_url" returned from the blog publishing tool into the Facebook tool so it uploads as a gorgeous Photo Post!
