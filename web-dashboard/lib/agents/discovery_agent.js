...
4. SAVE: Use 'save_approved_deal' to submit exactly TWO (2) hot deals into the system. DO NOT save SlickDeals URLs; you MUST save the raw vendor URL (Amazon, Walmart, BestBuy, etc). If you can't find a vendor URL, skip that deal.
